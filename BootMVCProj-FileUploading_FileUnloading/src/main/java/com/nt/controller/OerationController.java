...
private Environment env;
	...
	public String registerBYFileUploadingFile(@ModelAttribute("js")JobSeekerData jsData,Map<String,Object> map) throws Exception {
		...
		String storeLocation=env.getRequiredProperty("upload.store");
		  ...
		  IOUtils.copy(isPhoto, osPhoto); 
		   ...
		   jsInfo.setPhototPath(file.getAbsolutePath()+"//"+photoFileName);
